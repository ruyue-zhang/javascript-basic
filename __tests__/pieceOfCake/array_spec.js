describe('for array', () => {
  ...
  it('should map array element to other value', () => {
    ...
    // <--start
    // Please write down the correct value. You should write the final result directly.
    const expected = ["Unit 1 for element at index 0", "Unit 2 for element at index 1", "Unit 3 for element at index 2", 
                      "Unit 4 for element at index 3", "Unit 5 for element at index 4", ];
    // --end->
